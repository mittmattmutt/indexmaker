...
At this point, things are looking okay--you'll get about like that quoted at the start of this section. We then pass that to the horrifically convoluted indexprint() which formats it in a readable way, returning a string. And that's it.
